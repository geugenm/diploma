...
\noindent Специальность \remainingfield{3.2cm}{1-31 04 04 "Аэрокосмические радиоэлектронные и информа-} \\
\fullfield{ционные системы и технологии"} \\

\noindent Тема дипломной работы (дипломного проекта) \remainingfield{10cm}{Оценка влияния солнечной актив-} \\
\fullfield{ности на работу бортовых систем низкоорбитальных спутников с использова-} \\
\fullfield{нием алгоритма машинного обучения XGBoost и построения графа связности} \\
...
расчетно-пояснительной записки \remainingfield{7cm}{Анализ влияния солнечной активности на } \\
\fullfield{функционирование спутниковых систем, разработка и обучение модели XG-} \\
...
обязательных чертежей и графиков) \remainingfield{7.8cm}{} \\
\fullfield{} \\
\fullfield{}
...
(дипломного проекта) \remainingfield{5cm}{Февраль 2025: анализ литературы по космической} \\
