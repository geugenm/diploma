...
% === ТИТУЛЬНАЯ СТРАНИЦА === %
\bsutitle{Оценка влияния солнечной активности на работу бортовых систем
...
«Аэрокосмические радиоэлектронные и информационные системы и технологии»}{Научный руководитель: \\
...
\newpage
\appendix
\input{attachments}             % TODO: Переименовать в 'appendices'
